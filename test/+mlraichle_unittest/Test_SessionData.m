	...
	methods (Test)
        ...
        function test_T1(this)
            this.verifyEqual(this.testObj.T1('typ', 'fqfn'), ...
                fullfile(this.vloc, 'T1001.4dfp.ifh'));
        end     
        ...
        function test_tracerListmodeSif(this)
            this.verifyEqual( ...
                ...
                fullfile(this.testObj.tracerListmodeLocation, 'FDG_V1-LM-00-OP.4dfp.ifh'));
        end
...
%                 fullfile(this.testObj.sessionPath, 'V1', 'FDG_V1-NAC', 'FDG_V1-LM-00-OP.4dfp.ifh'));
        ...
        function test_tracerRevision(this)
            ...
            this.verifyEqual(this.testObj.tracerRevision, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/%sv%ir1.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum));
            % fdgv1r1.4dfp.ifh            
            this.testObj.epoch = 1;             
            this.verifyEqual(this.testObj.tracerRevision, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1/%sv%ie1r1.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum));
            % E1/fdgv1e1r1.4dfp.ifh
            this.testObj.epoch = 1:4; 
            this.verifyEqual(this.testObj.tracerRevision, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1to4/%sv%ie1to4r1.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum));
            % E1to4/fdgv1e1to4r1.4dfp.ifh  
            this.testObj.rnumber = 2;
            this.verifyEqual(this.testObj.tracerRevision, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1to4/%sv%ie1to4r2.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum));
            % E1to4/fdgv1e1to4r2.4dfp.ifh  
        end
        ...
        function test_tracerResolved(this)
            ...
            this.verifyEqual(this.testObj.tracerResolved, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/%sv%ir1_op_%sv%ir1.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum, lower(this.tracer), this.vnum));
            % fdgv1r1_op_fdgv1r1.4dfp.ifh
            this.testObj.epoch = 1;            
            this.verifyEqual(this.testObj.tracerResolved, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1/%sv%ie1r1_op_%sv%ie1r1.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum, lower(this.tracer), this.vnum));
            % E1/fdgv1e1r1_op_fdgv1e1r1.4dfp.ifh
            this.testObj.epoch = 1; 
            this.testObj.resolveTag = this.testObj.resolveTagFrame(24, 'reset', true);  
            this.verifyEqual(this.testObj.tracerResolved, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1/%sv%ie1r1_op_%sv%ie1r1_frame24.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum, lower(this.tracer), this.vnum));
            % E1/fdgv1e1r1_op_fdgv1e1r1_frame24.4dfp.ifh  
            this.testObj.epoch = 1:4;
            this.testObj.resolveTag = this.testObj.resolveTagFrame(4, 'reset', true);              
            this.verifyEqual(this.testObj.tracerResolved, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1to4/%sv%ie1to4r1_op_%sv%ie1to4r1_frame4.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum, lower(this.tracer), this.vnum));
            % E1to4/fdgv1e1to4r1_op_fdgv1e1to4r1_frame4.4dfp.ifh 
            this.testObj.rnumber = 2;
            this.verifyEqual(this.testObj.tracerResolved, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1to4/%sv%ie1to4r2_op_%sv%ie1to4r1_frame4.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum, lower(this.tracer), this.vnum));
            % E1to4/fdgv1e1to4r2_op_fdgv1e1to4r1_frame4.4dfp.ifh 
        end
        function test_tracerResolvedFinal(this)
            this.testObj.attenuationCorrected = true;
            this.verifyEqual(this.testObj.tracerResolvedFinal, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/%sv%ir1_op_%sv%ie1to4r1_frame4.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum, lower(this.tracer), this.vnum));
            % fdgv1r1_op_fdgv1e1to4r1_frame4.4dfp.ifh
            this.testObj.epoch = 1;
            this.verifyEqual(this.testObj.tracerResolvedFinal, ...
                sprintf('%s/%s/V%i/%s_V%i-AC/E1/%sv%ie1r1_op_%sv%ie1to4r1_frame4.4dfp.ifh', ...
                this.studyd.subjectsDir, this.sessf, this.vnum, this.tracer, this.vnum, ...
                lower(this.tracer), this.vnum, lower(this.tracer), this.vnum));
            % E1/fdgv1e1r1_op_fdgv1e1to4r1_frame4.4dfp.ifh            
        end
