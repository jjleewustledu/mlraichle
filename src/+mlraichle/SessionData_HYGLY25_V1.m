classdef SessionData_HYGLY25_V1 < mlpipeline.ResolvingSessionData
	%% SESSIONDATA  
        ...
        function g = get.taus(this)
            if (~this.attenuationCorrected)
                switch (upper(this.tracer))
                    case 'FDG'
                        g = [30,30,30,30,30,30,30,30,30,30,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60];
                        % length -> 57
                    case {'OC' 'CO'}
                ...
                switch (upper(this.tracer))
                    case 'FDG'
                        g = [10,10,10,10,10,10,10,10,10,10,10,10,30,30,30,30,30,30,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60];
                        % length -> 65
                    case {'OC' 'CO'}
