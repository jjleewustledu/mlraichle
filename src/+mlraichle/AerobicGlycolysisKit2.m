classdef AerobicGlycolysisKit2 < handle & mlraichle.AerobicGlycolysisKit
	%% AEROBICGLYCOLYSISKIT2  
...
%            fs = sesd.fsOnAtlas('typ', 'mlfourd.ImagingContext2', 'tags', '_b43_wmparc1');
            ...
            [cbf_,msk_] = AerobicGlycolysisKit2.constructCbfAndSupportInfo(sesd);
            Fsc_ = AerobicGlycolysisKit2.iccrop(cbf_, 1:3);
            AerobicGlycolysisKit2.ic2mat(Fsc_)
            AerobicGlycolysisKit2.ic2mat(msk_)
            popd(pwd0)
        end  
        function [cbf,msk] = constructCbfAndSupportInfo(varargin)
            ...
            this = mlraichle.AerobicGlycolysisKit2.createFromSession(varargin{:});
        ...
        function [ks,msk]  = constructCmrglcByRegion(varargin)
            ...
            % build mat files for cbf, msk  
            [cmrglc,Ks,msk] = AerobicGlycolysisKit2.constructCmrglcAndSupportInfo(sesd);
            Ksc = AerobicGlycolysisKit2.iccrop(Ks, 1:4);
            AerobicGlycolysisKit2.ic2mat(Ksc)
            AerobicGlycolysisKit2.ic2mat(cmrglc)
            AerobicGlycolysisKit2.ic2mat(msk)
            popd(pwd0)
        end  
...
%           os = sesd.osOnAtlas('typ', 'mlfourd.ImagingContext2', 'tags', '_b43_wmparc1');
            ...
            %[cmro2_,msk_] = AerobicGlycolysisKit2.constructCmro2AndSupportInfo(sesd);
            %Osc_ = AerobicGlycolysisKit2.iccrop(cmro2_, 1:3);
            %AerobicGlycolysisKit2.ic2mat(Osc_)
            %AerobicGlycolysisKit2.ic2mat(msk_)
            popd(pwd0)
        end
...
%            gs = []; % DEBUGGING
            ...
            % build mat files for cbf, msk            
            [cbf_,msk_] = AerobicGlycolysisKit2.constructCbfAndSupportInfo(sesd);
            Gsc_ = AerobicGlycolysisKit2.iccrop(cbf_, 1:3);
            AerobicGlycolysisKit2.ic2mat(Gsc_)
            AerobicGlycolysisKit2.ic2mat(msk_)
            popd(pwd0)
        end  
        function             constructSubjectByRegion(varargin)   
            ...
            import mlraichle.*
            import mlraichle.AerobicGlycolysisKit2.*
            ...
            for sesf = sesfs(contains(sesfs, ipr.sessionsExpr))
                try
                    ...
                    if ipr.saveMat
                        ...
                        fdg = fdg.blurred(4.3);
                        AerobicGlycolysisKit2.ic2mat(fdg)
                    end
                    
                    AerobicGlycolysisKit2.(['constructKsBy' Region])(sesd); % memory ~ 5.5 GB
                catch ME
                    handwarning(ME)
                end
            end            
        ...
        function             constructSubjectByWmparc1(varargin)
            ...
            mlraichle.AerobicGlycolysisKit2.constructSubjectByRegion(varargin{:}, 'region', 'wmparc1')               
        end
        ...
        function this      = createFromSession(varargin)
            this = mlraichle.AerobicGlycolysisKit2('sessionData', varargin{:});
        end
        function these     = createFromSubjectSession(varargin)
            ...
            %  @return these is {mlraichle.AerobicGlycolysisKit2, ...}
        ...
        function             plotDxDTimes(varargin)
            ...
            %         mlpet.AerobicGlycolysisKit2.buildKsByWmparc1().    
            ...
            this = mlraichle.AerobicGlycolysisKit2.createFromSubjectSession(varargin{:});            
    ...
    methods
        ...
        function fs    = buildFsByWmparc1(this, varargin)
            ...
            import mlraichle.AerobicGlycolysisKit2.index2histology
        ...
        function gs    = buildGsByWmparc1(this, varargin)
            ...
            for idx = 1:length(this.indicesL) % parcs
                ...
                % for parcs, build roibin as logical, roi as single                    
                fprintf('starting mlpet.AerobicGlycolysisKit2.buildGsByWmparc1.indices -> %i, %i\n', ...
                ...
                if any(this.indicesL(idx) == ipr.indicesToCheck)                        
                    h = raichle.plot();
                    title(sprintf('AerobicGlycolysisKit2.buildGsByWmparc1:  indices %i, %i\n%s', ...
        ...
        function ks    = buildKsByWmparc1(this, varargin)
            ...
            for idx = this.indices % parcs
                ...
                % for parcs, build roibin as logical, roi as single                    
                fprintf('starting mlpet.AerobicGlycolysisKit2.buildKsByWmparc1.idx -> %i\n', idx)
                tic
                roi = copy(wmparc1);
                ...
                if any(idx == ipr.indicesToCheck)                        
                    h = huang.plot();
                    title(sprintf('AerobicGlycolysisKit2.buildKsByWmparc1:  idx == %i\n%s', idx, datestr(sesd.datetime)))
                    try
                        dtTag = lower(sesd.doseAdminDatetimeTag);
                        savefig(h, ...
                            fullfile(workdir, ...
	...
	methods (Access = protected)		  
 		function this = AerobicGlycolysisKit2(varargin)
